...
const Home = () => {
  ...
  return (
    <div className="pt-16 md:pt-20 xl:pt-32 max-w-screen-xl" id="home">
      <div className="flex flex-col md:flex-row pt-20">
        <div className="w-full md:w-2/4 sm:pr-20 md:pr-0">
          ...
          <div className="pt-8 md:pt-10 xl:pt-16">
            <button    onClick={ ()=>{ scrollViewInit("contact")} } className="py-4 px-4 border-2 border-purple-400 text-xl" >
              Contact Me !!
            </button>
          </div>
        </div>
